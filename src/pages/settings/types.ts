...
export const BUILTIN_TOOLS: ToolConfig[] = [
    ...
    { id: "cline", name: "Cline", globalPath: "~/.cline/skills/", projectPath: ".cline/skills/", detected: false, hasGlobalPath: true },
    ...
    { id: "kiro", name: "Kiro", globalPath: "~/.kiro/skills/", projectPath: ".kiro/skills/", detected: false, hasGlobalPath: true },
