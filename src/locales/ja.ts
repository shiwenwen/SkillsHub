...
export const ja: Translations = {
    ...
    settings: {
        ...
        aboutSubtitle: "AI Skills の統合管理",
        aboutVersion: "v1.0.5",
        aboutAuthorLabel: "作者",
        aboutOpenSourceLabel: "オープンソース",
        ...
        updateCheckAgain: "再確認",
        updateAvailable: "新しいバージョンが利用可能",
        updateReleaseNotes: "リリースノート",
        updateDownloadInstall: "ダウンロードしてインストール",
        updateDownloading: "アップデートをダウンロード中...",
        updateReadyRestart: "アップデート準備完了、再起動して適用",
